...
class ICNC2:
    ...
    def GetDLLVersion(self):
        ...
        """
        ans = self.ICNC2Lib._ICNC_GetDLLVersion()
        return ans
    ...
    def SetSimulationMode(self,SimulationModeVal):
        ...
        """
        ans = self.ICNC2Lib._ICNC_SetSimulationMode(SimulationModeVal)
        return ans
    ...
    def Disconnect(self):
        ...
        """
        self.connected = 0
        ans = self.ICNC2Lib._ICNC_Disconnect()
        return ans
    ...
    def ErrorReset(self, ErrorBits):
        ...
        """
        ans = self.ICNC2Lib._ICNC_ErrorReset(ErrorBits)
        return ans
    ...
    def GetBoardStatus(self, StatusType): # output param:      *Status 
        ...
        """
        myInt = ctypes.c_int()
        ans = self.ICNC2Lib._ICNC_GetBoardStatus(StatusType,ctypes.byref(myInt))
        return ans,myInt
    ...
    def SlowStopAllAndClear(self):
        ...
        """
        ans = self.ICNC2Lib._ICNC_SlowStopAllAndClear()
        return ans,myInt
    ...
    def GetInput(self, InNo): # output param:  *InputState (bool)
        """
        Lecture de l'etat d'une des entrees
        """
        myInt = ctypes.c_int()
        ans = self.ICNC2Lib._ICNC_GetInput(InNo,ctypes.byref(myInt))
        return ans,myInt
    ...
    def GetInputAll(self): # output param:   *InputState 
        ...
        """
        myInt = ctypes.c_int()
        ans = self.ICNC2Lib._ICNC_GetInputAll(ctypes.byref(myInt))
        return ans,myInt
    ...
    def SetOutput(self,    OutputNo, OutputState):
        ...
        """
        ans = self.ICNC2Lib._ICNC_SetOutput(self, OutputNo, OutputState)
        return ans
    ...
    def GetBufferStatus(self): # output param: *FreeBufferSpace 
        ...
        """
        myInt = ctypes.c_int()
        ans=self.ICNC2Lib._ICNC_GetBufferStatus(ctypes.byref(myInt))
        return ans,myInt
    ...
    def WriteUserMem(self, MemoryNumber,  MemoryValue):
        ...
        Memory number = 0 a 9
        """
        ans = self.ICNC2Lib._ICNC_WriteUserMem(MemoryNumber,  MemoryValue)
        return ans
    ...
    def WriteParameter(self, ParameterID,  ParameterValue,  WaitCompletion=True,  TimeOut=1000):
        ...
        """
        ans = self.ICNC2Lib._ICNC_WriteParameter(ParameterID, ParameterValue, WaitCompletion, TimeOut)
        return ans
    ...
    def MachineHome(self, Axis, MaxStrokeX=0xFFFFFFFF, MaxStrokeY=0xFFFFFFFF, MaxStrokeZ=0xFFFFFFFF, MaxStrokeA=0xFFFFFFFF, MaxStrokeB=0xFFFFFFFF):
        ...
        """
        ans = self.ICNC2Lib._ICNC_MachineHome(Axis, MaxStrokeX, MaxStrokeY, MaxStrokeZ, MaxStrokeA, MaxStrokeB)
        return ans
    ...
    def MoveProfileAbsAsync(self, Axe, FStartStop, Accel, Speed, Decel,   Position):
        ...
        """
        ans = self.ICNC2Lib._ICNC_MoveProfileAbsAsync(Axe,FStartStop,Accel,Speed,Decel,Position)
        return ans
    ...
    def MoveProfileRelAsync(self, Axe, FStartStop, Accel, Speed, Decel,   Distance):
        ...
        Si l'axe est deja en mouvement et la cible inchangee, la commande prend en compte la nouvlle vitesse et le profile est ajuste.
        """
        ans = self.ICNC2Lib._ICNC_MoveProfileRelAsync(Axe,FStartStop,Accel,Speed,Decel,Position)
        return ans
    ...
    def SetOutputBuf(self, OutputNo, OutputValue):
        """
        """
        ans = self.ICNC2Lib._ICNC_SetOutputBuf(OutputNo, OutputValue)
        return ans
    ...
    def WaitBuf(self, TimeToWait):
        ...
        TimeToWait en 100ms
        """
        ans = self.ICNC2Lib._ICNC_WaitBuf(TimeToWait)
        return ans
    ...
    def MoveSpeedAbsBuf(self, Axis, Speed, MoveX, MoveY, MoveZ, MoveA, MoveB): # output param: *BufferRequired=NULL 
        ...
        sur le PC afin d'envoyer des trames completes sur la cartee et optimiser le flux de communication USB
        """
        ans = self.ICNC2Lib._ICNC_MoveSpeedAbsBuf(Axis, Speed, MoveX, MoveY, MoveZ, MoveA, MoveB)
        return ans
